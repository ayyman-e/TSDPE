...
from tsdpe.helpers import resample_signals, period_batching  # Adjust this import to your package structure
...
def test_dataset_fusion_shape():
    ...
    dataset1 = generate_sine_wave(1, 10, 10).reshape(-1, 1)  # 1 Hz, 10 samples/sec, 1 second
    dataset2 = generate_sine_wave(1, 20, 10).reshape(-1, 1)  # 1 Hz, 20 samples/sec, 1 second
    ...
    fused_dataset = dataset_fusion([dataset1, dataset2], sampling_frequencies, no_periods_per_slice)
